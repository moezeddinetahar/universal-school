...
position:relative;
  ...
  bottom: 0;
  left: 0;
    background-color: rgba(17, 17, 17, 1); /* Couleur de fond avec une certaine opacité pour le flou */
    margin-top:13%;
}
footer .content{
  max-width: 1350px;
...
@media (max-width:560px){
 ...
 <footer>
   <div class="content">
     <div class="left box">
       ...
       <div class="lower">
         ...
         <div class="phone">
           <a href="#"><i class="fas fa-phone-volume"></i>+216 99 789 456</a>
         </div>
         <div class="email">
           <a href="#"><i class="fas fa-envelope"></i>contact@gmail.com</a>
         </div>
       </div>
     </div>
   ...
   <div class="bottom">
     <p>Copyright © 2024 <a href="#">Moezeddine Tahar</a> All rights reserved</p>
   </div>
 </footer>
